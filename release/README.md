...
- `app-v2.0.2.apk`: current 2.0.2 package. It adds resumable audio uploads, durable computer-side jobs, offline progress recovery, and reusable audio/English/bilingual caches.
