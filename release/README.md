...
- `app-v2.0.2.apk`: current 2.0.2 package. It adds resumable audio uploads, durable computer-side jobs, offline progress recovery, and reusable audio/English/bilingual caches. Pair it with `tools/start_video_english_service_v2.0.2.ps1` and `tools/local_whisper_service_v2.0.2.py`.
