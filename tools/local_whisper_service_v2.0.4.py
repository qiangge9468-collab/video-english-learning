...
try:
    from durable_job_store_v2_0_4 import DurableJobStore
    from semantic_caption_segmenter import SegmenterConfig, segment_words as semantic_segment_words
except ModuleNotFoundError:
    from tools.durable_job_store_v2_0_4 import DurableJobStore
...
SERVICE_DATA_DIR = os.environ.get(
    ...
    os.path.join(PROJECT_ROOT, "service_data_v2.0.4"),
)
...
def run_semantic_worker(raw_words):
    ...
    worker_path = os.path.join(PROJECT_ROOT, "tools", "semantic_segmenter_worker_v2_0_4.py")
