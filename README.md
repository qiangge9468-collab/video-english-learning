...
- v2.0.0 新增底部四个页面：`学习`、`处理中`、`已完成`、`我的`，并加入图标化底部导航和空状态插画。
- `处理中` 页面支持一次选择多个视频，后台排队生成英文字幕并自动调用电脑端翻译成中文。
- `已完成` 页面集中管理已经生成好中英双语字幕的视频，可开始学习、导出、重翻或删除记录。
- `我的` 页面包含使用说明、电脑端服务说明、作者信息和版本信息。
...
| `release/app-v2.0.0.apk` | 2.0.0 | 推荐安装的新版本 | 新增底部四页：学习、处理中、已完成、我的；加入图标化导航和空状态插画；支持批量选择多个视频后台排队生成英文字幕和中文翻译；已完成视频可集中管理、开始学习、导出、重翻或删除。 |
